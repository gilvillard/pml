                                  ...
                                  mp_limb_t power_two, vec2d p2, vec2d pinv2)
{
    ...
    total_low1 = sum_low1.e1[0] + sum_low1.e1[1] + sum_low1.e2[0] + sum_low1.e2[1] + (acc_last1 & ((1L << 45) - 1));
    total_high1 = sum_high1.e1[0] + sum_high1.e1[1] + sum_high1.e2[0] + sum_high1.e2[1] + (acc_last1 >> 45);
    total_low2 = sum_low2.e1[0] + sum_low2.e1[1] + sum_low2.e2[0] + sum_low2.e2[1] + (acc_last2 & ((1L << 45) - 1));
    total_high2 = sum_high2.e1[0] + sum_high2.e1[1] + sum_high2.e2[0] + sum_high2.e2[1] + (acc_last2 >> 45);
